...
func TestPhonebook(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want:    map[string]string{"Vladimir": "+37138972685", "Dmitry": "+37172228266", "Daniel": "+37151246471"},
		},
		{
			...
			want:    map[string]string{"Alex": "+37180531738", "Vladimir": "+37147086024", "Dmitry": "+37175819718", "Daniel": "+37156100264"},
		},
	}
